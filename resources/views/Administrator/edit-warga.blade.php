        ...
        <div class="col">
            <div class="card shadow border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('warga-update', Crypt::encrypt($warga->id)) }}" method="POST" id="wargaForm">
                        @csrf
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control" 
                                        value="{{ $warga->name }}" placeholder="Masukkan nama lengkap" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="username" class="form-control" 
                                        value="{{ $warga->user->username }}" placeholder="Masukkan username" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="number_handphone" class="form-control" 
                                        value="{{ $warga->number_handphone }}" placeholder="Masukkan nomor telepon" required
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="addres" class="form-control" 
                                    placeholder="Masukkan alamat lengkap" value="{{ $warga->addres }}" required></input>
                            </div>
                        </div>
