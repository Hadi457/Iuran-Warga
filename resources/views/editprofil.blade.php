        ...
        <div class="card border-0 shadow-sm mx-auto bg-white" style="width: 500px; height:auto">
            ...
            <div class="card-body px-4 py-5" style="display:flex; flex-direction:column; justify-content:center; align-items:center">
                <div class="mt-5" style="width: 400px; justify-content: center; align-items: center; display: flex; flex-direction: column;">
                        <input type="text" name="name" class="form-control mb-3" placeholder="Nama" value="{{ $user->name ?? '' }}">
                        <input type="text" name="username" class="form-control mb-3" placeholder="Username" value="{{ $user->username ?? '' }}">
                        <input type="text" name="alamat" class="form-control mb-3" placeholder="Alamat" value="{{ $user->alamat ?? '' }}">
                        <input type="text" name="no_telepon" class="form-control mb-3" placeholder="Nomor Telepon" value="{{ $user->no_telepon ?? '' }}">
                        <input type="text" name="password" class="form-control mb-3" placeholder="Password" value="{{ $user->no_telepon ?? '' }}">
